...
public class Homeshop extends Fragment {
    View view;
    String url="http://tracking.vcommission.com/aff_c?offer_id=402&aff_id=59870";
    String input;
    String type,type2;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view=inflater.inflate(R.layout.homeshop, container, false);
        final WebView webView=(WebView)view.findViewById(R.id.homeshop_webview);
        ...
        if(type.equals("1")&&type2.equals("0")){
            ...
            webView.loadUrl("http://www.homeshop18.com/"+input+"/search:"+input+"/");
        }
