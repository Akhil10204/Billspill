...
public class Myntra extends Fragment {
    View view;
    ProgressDialog progressDialog;
    String url="http://tracking.vcommission.com/aff_c?offer_id=22&aff_id=59870";
    String input;
    String type,type2;
    WebView webView;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view=inflater.inflate(R.layout.myntra,container,false);
         webView = (WebView) view.findViewById(R.id.myntra_webview);
        ...
        if(type.equals("1")&&type2.equals("0")){
            ...
            webView.loadUrl("https://www.myntra.com/"+input+"?userQuery=true");
        }
