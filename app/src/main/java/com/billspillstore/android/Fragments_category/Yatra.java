...
public class Yatra extends Fragment {
    View view;
   SwipeRefreshLayout mySwipeRefreshLayout;
   WebView webView;
    String url="https://clk.omgt5.com/?AID=679063&PID=17432&UID=mobile";
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view=inflater.inflate(R.layout.yatra,container,false);
         webView=(WebView)view.findViewById(R.id.yatra_webview);
