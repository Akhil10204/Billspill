...
public class Clovia extends Fragment {
    View view;
    String url="http://tracking.vcommission.com/aff_c?offer_id=146&aff_id=59870";
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view=inflater.inflate(R.layout.clovia,container,false);
        final WebView webView=(WebView)view.findViewById(R.id.clovia_webview);
