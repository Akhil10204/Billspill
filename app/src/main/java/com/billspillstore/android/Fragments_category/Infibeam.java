...
public class Infibeam extends Fragment {
    View view;
    String url="http://tracking.payoom.com/aff_c?offer_id=812&aff_id=2927&source=mobile";
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view=inflater.inflate(R.layout.infibeam,container,false);
        final WebView webView=(WebView)view.findViewById(R.id.infibeam_webview);
