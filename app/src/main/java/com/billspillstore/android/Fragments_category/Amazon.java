...
public class Amazon extends Fragment {
    View view;
    String url="http://www.amazon.in/?tag=wwwbillspillc-21";
    String input;
    String type,type2;
   WebView webView;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view=inflater.inflate(R.layout.amazon,container,false);
           webView =(WebView)view.findViewById(R.id.amazon_webview);
        ...
        if(type.equals("1")&& type2.equals("0")){
            ...
            webView.loadUrl("http://www.amazon.in/s/ref=nb_sb_noss_2?url=search-alias%3Daps&field-keywords="+input);
    }
