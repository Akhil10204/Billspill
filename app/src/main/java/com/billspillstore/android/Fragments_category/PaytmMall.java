...
public class PaytmMall extends Fragment {
   View view;
    String url="https://clk.omgt5.com/?AID=679063&PID=30363&UID=mobile";
    String input;
    String type,type2;
    WebView webView;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view=inflater.inflate(R.layout.paytmmall,container,false);
       webView=(WebView)view.findViewById(R.id.paytmmall_webview);
        ...
        if(type.equals("1")&&type2.equals("0")){
            ...
            webView.loadUrl("https://paytmmall.com/shop/search?q="+input);
        }
