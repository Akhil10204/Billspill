...
public class Industrybuying extends Fragment {
    View view;
    String url="http://tracking.vcommission.com/aff_c?offer_id=2187&aff_id=59870";
    String input;
    String type,type2;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view=inflater.inflate(R.layout.industry,container,false);
        final WebView webView=(WebView)view.findViewById(R.id.industry_webview);
        ...
        if(type.equals("1")&&type2.equals("0")){
            ...
            webView.loadUrl("http://www.industrybuying.com/search/?q="+input+"&cat=");
        }
