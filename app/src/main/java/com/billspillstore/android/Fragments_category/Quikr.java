...
public class Quikr extends Fragment {
  View view;
    String url="http://www.quikr.com/";
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view=inflater.inflate(R.layout.quikr,container,false);
        final WebView webView=(WebView)view.findViewById(R.id.quikr_webview);
