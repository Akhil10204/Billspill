...
public class Makemytrip extends Fragment {
    View view;
    WebView webView;
    SwipeRefreshLayout mySwipeRefreshLayout;
    String url="http://tracking.vcommission.com/aff_c?offer_id=3384&aff_id=59870&source=mobile";
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view=inflater.inflate(R.layout.makemytrip,container,false);
       webView=(WebView)view.findViewById(R.id.makemytrip_webview);
