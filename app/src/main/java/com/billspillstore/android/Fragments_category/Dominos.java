...
public class Dominos extends Fragment {
    ...
    String url="http://tracking.vcommission.com/aff_c?offer_id=180&aff_id=59870";
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view=inflater.inflate(R.layout.dominos,container,false);
        final WebView webView=(WebView)view.findViewById(R.id.dominos_webview);
