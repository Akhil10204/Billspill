...
public class Stalkbylove extends Fragment {
    View view;
    String url="https://clk.omgt5.com/?AID=679063&PID=13526&UID=mobile";
    String input;
    String type,type2;
    WebView webView;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view=inflater.inflate(R.layout.stalkbylove,container,false);
         webView=(WebView)view.findViewById(R.id.stalkbylove_webview);
        ...
        if(type.equals("1")&&type2.equals("0")){
            ...
            webView.loadUrl("http://www.stalkbuylove.com/women-"+input);
        }
