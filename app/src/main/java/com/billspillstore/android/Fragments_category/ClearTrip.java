...
public class ClearTrip extends Fragment {
   View view;
    SwipeRefreshLayout mySwipeRefreshLayout;
    String url="http://tracking.vcommission.com/aff_c?offer_id=2175&aff_id=59870";
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view=inflater.inflate(R.layout.cleartrip,container,false);
        final WebView webView=(WebView)view.findViewById(R.id.cleartrip_webview);
