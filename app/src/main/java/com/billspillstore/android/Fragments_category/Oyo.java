...
public class Oyo extends Fragment {
    View view;
    String url="http://tracking.payoom.com/aff_c?offer_id=546&aff_id=2927&source=mobiles";
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view=inflater.inflate(R.layout.oyo,container,false);
        final WebView webView=(WebView)view.findViewById(R.id.oyo_webview);
